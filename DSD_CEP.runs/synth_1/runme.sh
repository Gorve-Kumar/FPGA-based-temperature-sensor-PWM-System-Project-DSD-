...
HD_PWD='D:/Semester 7/DSD LAB/Lab 14/DSD_CEP/DSD_CEP.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CEP_CS125.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CEP_CS125.tcl
