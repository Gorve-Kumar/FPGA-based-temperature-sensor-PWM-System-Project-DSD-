...
HD_PWD='D:/Semester 7/DSD LAB/Lab 14/DSD_CEP/DSD_CEP.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CEP_CS125.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CEP_CS125.tcl -notrace
